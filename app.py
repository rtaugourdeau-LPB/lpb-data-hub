...
def page_docs():
    ...
    st.markdown(
        f"""
        Document centralisant les liens vers les dashboards BI, les accès et les infos utiles. Si vous avez besoin d’un accès à un dashboard BI, merci d’en faire la demande.
